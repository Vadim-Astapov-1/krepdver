...
function SliderProducts({ productList }) {
  ...
  const handleLastPostion = useCallback((widthCard) => {
  ...
  return(
    <div className='slider-products'>
      ...
      <div className='slider-products__container'>
        {position > 0 && <button type='button' className='slider-products__btn' onClick={scrollLeft}></button>}
        {position < lastPosition && <button type='button' className='slider-products__btn slider-products__btn_type_right' onClick={scrollRight}></button>}
